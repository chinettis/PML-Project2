...
Partitioning the training set in two:
...
![](Project_PML_files/figure-markdown_github/unnamed-chunk-9-1.png)
...
![](Project_PML_files/figure-markdown_github/unnamed-chunk-11-1.png)
...
![](Project_PML_files/figure-markdown_github/unnamed-chunk-12-1.png)

``` r
plot(cmrf$table, col = cmtree$byClass, main = paste("Random Forest Confusion Matrix: Accuracy =", round(cmrf$overall['Accuracy'], 4)))
```

![](Project_PML_files/figure-markdown_github/unnamed-chunk-12-2.png)
